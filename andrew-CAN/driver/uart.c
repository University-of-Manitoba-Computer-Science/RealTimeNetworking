...
void initUART(){
    ...
    SERCOM5_REGS->USART_INT.SERCOM_CTRLA = SERCOM_USART_INT_CTRLA_MODE_USART_INT_CLK |  SERCOM_USART_INT_CTRLA_RXPO(SERCOM5_RX_MODE) | SERCOM_USART_INT_CTRLA_TXPO(SERCOM5_TX_MODE) | SERCOM_USART_INT_CTRLA_DORD_Msk | SERCOM_USART_INT_CTRLA_ENABLE_Msk;
...
void rs485Ports(){
    ...
    //PB14 for DE
    PORT_REGS->GROUP[1].PORT_DIRSET = PORT_PB22;
    PORT_REGS->GROUP[1].PORT_OUTSET = PORT_PB22;
